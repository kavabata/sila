...
return [
  ...
  'sections' => [
    'about' => [
      'title' => 'O nas',
      'description' => [
        'paragraph1' => 'Fundacja koncentruje się na szerokiej gamie działań społecznych, mających na celu pomoc osobom w trudnej sytuacji życiowej, wspieranie integracji społecznej i zawodowej, działalność charytatywną oraz promowanie tradycji narodowych i kulturowych. Wspiera również integrację cudzoziemców, osoby niepełnosprawne i emerytów, równouprawnienie płci, rozwój edukacji, kultury i sportu, ochronę środowiska oraz prawa człowieka. Fundacja angażuje się w pomoc ofiarom katastrof, promuje wolontariat i współpracę międzynarodową, a także wspiera Polonię za granicą.',
        'paragraph2' => 'Od 24 lutego 2022 r., nasza fundacja z zaangażowaniem koordynuje pracę wolontariuszy, skupiając się na wsparciu i pomocy uchodźcom z Ukrainy. Na podstawie tych działań powstała nasza fundacja, której misją jest niesienie pomocy najbardziej potrzebującym.',
        'paragraph3' => 'Naszym pierwszym projektem było otwarcie pierogarni, która stała się miejscem wspólnoty i solidarności dla ponad 100 kobiet – Ukrainek, Polek oraz kobiet innych narodowości, które znalazły schronienie w Polsce. Wrocławscy przedsiębiorcy, wykazując ogromne serce, nieodpłatnie dostarczali produkty do wyrobu pierogów. Cały dochód ze sprzedaży tych ukraińskich specjałów został przeznaczony na wsparcie uchodźców z Ukrainy, niosąc im nadzieję i niezbędną pomoc w trudnym czasie. Do lokalu po pierogi ustawiały się długie kolejki, a ludzie okazywali ogromne wsparcie. Wspólne działanie pokazało, że razem możemy osiągnąć najlepsze rezultaty i przynieść realne wsparcie potrzebującym.',
        'paragraph4' => 'Kolejnym z naszych projektów jest świadczenie wsparcia społecznego dla kobiet z dziećmi, które przybyły z Ukrainy i znajdują się w okresie adaptacji w nowym kraju w sytuacji stresowej. Nasza pomoc obejmuje szeroki zakres usług, takich jak wsparcie psychologiczne, informacyjne i medyczne, poradnictwo prawne oraz pomoc w poszukiwaniu mieszkania. Dodatkowo oferujemy wsparcie humanitarne, które nie tylko pomaga naszym beneficjentom po powrocie do Ukrainy, ale także dostarcza pomoc tym, którzy pozostają na miejscu.',
        'paragraph5' => 'Nasz trzeci projekt skupia się na zapewnieniu wsparcia osobom w wieku 40+. Organizujemy regularne spotkania integracyjne, które są skierowane głównie do seniorów. Spotkania te odbywają się raz w miesiącu i obejmują przyjemne występy muzyków reprezentujących różnorodne style muzyczne, które nawiązują zarówno do polskich, jak i ukraińskich tradycji. Każde spotkanie gromadzi od 15 do 40 uczestników, tworząc przyjazną i wspierającą atmosferę dla wszystkich uczestników.',
        'paragraph6' => 'Nasz czwarty projekt to organizacja corocznego międzynarodowego festiwalu Wyszywanki, który odbywa się na otwartym terenie i gromadzi około 200 osób z różnych mniejszości narodowych. Festiwal Wyszywanki to wyjątkowe wydarzenie, które celebruje bogactwo kultur poprzez prezentacje tradycyjnych strojów, pieśni i tańców ludowych. Uczestnicy mają okazję brać udział w warsztatach rękodzieła, gdzie mogą nauczyć się unikalnych technik artystycznych i rzemieślniczych. Festiwal tworzy przestrzeń do wymiany kulturowej, promując zrozumienie i szacunek dla różnorodności, a także wzmacniając więzi między różnymi społecznościami. Jest to nie tylko okazja do zabawy i nauki, ale także do budowania wspólnoty i dzielenia się tradycjami, które kształtują nasze dziedzictwo.',
      ],
      'cards' => [
        'documents' => [
          'title' => 'Dokumenty',
